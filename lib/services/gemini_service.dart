...
Google検索とGoogleマップを利用し、下記条件に当てはまり実在する店を最小10件、最大20件教えてください。
「ぐるなび」や「食べログ」には掲載されていないような、地元密着型の店が理想です。
...
[
  {
    ...
    "solo_score": 一人食事向けスコア（0-100の整数）,
    "reason": "推奨理由（日本語で1-2文、具体的に）",
    "tags": ["タグ1", "タグ2", "タグ3"]（例: カウンター席あり、一人客歓迎、落ち着いた雰囲気など、検索情報からその店についてピックアップすべき要素をタグで表現）,
